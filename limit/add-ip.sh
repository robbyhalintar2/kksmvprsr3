...
data_ip="https://raw.githubusercontent.com/robbyhalintar2/kksmvprsr3/main/izinIP"
checking_sc() {
...
checking_sc
clear
Repo1="https://raw.githubusercontent.com/robbyhalintar2/kksmvprsr3/main/"
cd izin
export MYIP=$( curl -sS ipv4.icanhazip.com/ )
SELLER=$(curl -sS ${Repo1}ip | grep $MYIP | awk '{print $2}')
Exp100=$(curl -sS ${Repo1}ip | grep $MYIP | awk '{print $3}')
data_ip="https://raw.githubusercontent.com/robbyhalintar2/kksmvprsr3/main/izin"
cd izin
...
REPO="https://github.com/robbyhalintar2/kksmvprsr3.git"
EMAIL="robbyhalintar2@gmail.com"
USER="robbyhalintar2"
...
TIMES="10"
CHATID="5857877733"
KEY="6153997105:AAHkYWlH4kpete42Fz9sp9azLzrXXRmPrOw"
URL="https://api.telegram.org/bot$KEY/sendMessage"
   ...
   # read -p "  Input Username IP (Example : Lt) : " name
    ...
    git remote add origin https://github.com/kksmvprsr3/kksmvprsr3
    git push -f https://${TOKEN}@github.com/kksmvprsr3/kksmvprsr3.git &> /dev/null
    cd izinIp
    rm -rf /root/scvps
    clear
    sleep 1
