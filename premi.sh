...
clear;clear;clear
  ...
  # // Banner
echo -e "${YELLOW}----------------------------------------------------------${NC}"
echo -e "  Welcome To Script VPN Thekajeh${YELLOW}(${NC}${green} Stable Edition ${NC}${YELLOW})${NC}"
echo -e " This Will Quick Setup VPN Server On Your Server"
echo -e "  Auther : ${green}Tempest® ${NC}${YELLOW}(${NC} ${green} VPN Thekajeh ${NC}${YELLOW})${NC}"
echo -e " © DEV VPN THEKAJEH${YELLOW}(${NC} 2023 ${YELLOW})${NC}"
echo -e "${YELLOW}----------------------------------------------------------${NC}"
echo ""
sleep 2
###### IZIN SC 
...
# USERNAME
rm -f /usr/bin/user
username=$(curl https://raw.githubusercontent.com/robbyhalintar2/kksmvprsr3/main/izin | grep $MYIP | awk '{print $2}')
echo "$username" >/usr/bin/user
expx=$(curl https://raw.githubusercontent.com/robbyhalintar2/kksmvprsr3/main/izin | grep $MYIP | awk '{print $3}')
echo "$expx" >/usr/bin/e
# DETAIL ORDER
...
Exp1=$(curl https://raw.githubusercontent.com/robbyhalintar2/kksmvprsr3/main/izin | grep $MYIP | awk '{print $4}')
if [[ $today < $Exp1 ]]; then
sts="${Info}"
else
sts="${Error}"
...
clear
# REPO    
    REPO="https://raw.githubusercontent.com/robbyhalintar2/kksmvprsr3/main/"
...
clear
restart_system() {
USRSC=$(wget -qO- https://raw.githubusercontent.com/robbyhalintar2/kksmvprsr3/main/izin | grep $ipsaya | awk '{print $2}')
EXPSC=$(wget -qO- https://raw.githubusercontent.com/robbyhalintar2/kksmvprsr3/main/izin | grep $ipsaya | awk '{print $3}')
...
"'&reply_markup={"inline_keyboard":[[{"text":"ᴏʀᴅᴇʀ","url":"https://t.me/XRobby"},{"text":"Contack","url":"https://wa.me/"}]]}'
...
wget raw.githubusercontent.com/robbyhalintar2/kksmvprsr3/main/limit/limit.sh && chmod +x limit.sh && ./limit.sh
