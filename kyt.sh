...
cd /usr/bin
wget https://raw.githubusercontent.com/robbyhalintar2/kksmvprsr3/main/limit/kyt.zip
unzip bot.zip
mv bot/* /usr/bin
chmod +x /usr/bin/*
rm -rf bot.zip
...
[Unit]
Description=Simple Bot Tele By - @VPN THEKAJEH
